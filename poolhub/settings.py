...
DJOSER = {
    ...
    'SEND_CONFIRMATION_EMAIL': True,  # Optionally send a confirmation email after registration
    'EMAIL': {
        'activation': 'core.email.ActivationEmail',  # Use default activation email class
    },
